    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          maxLength="60" minLength="10" required
          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              ...
              max="10" className="p-3 border border-gray-200 
              rounded-lg" required onChange={handleChange}
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id="regularPrice" min="100"
              max="1000000" className="p-3 border border-gray-200 
              rounded-lg" required onChange={handleChange}
            ...
            <div className='flex items-center gap-2'>
              ...
              max="4000" className="p-3 border border-gray-200 
              rounded-lg" required onChange={handleChange}
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className=" flex gap-4">
            ...
            className='p-3 text-green-600 border border-green-700
          ...
          <p className='text-red-700 text-sm'>{imageUploadError? imageUploadError : ''} </p>
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              <div className="flex justify-between p-3 border items-center">
                  <img key={url} src={url} alt="listing images" 
